...
const characters = [
  {
    ...
    powers:
      "Powered armored suit that grants superhuman strength, flight, durability, advanced targeting systems, repulsor blasts, missile launchers, and AI integration.",
    weapons:
      "Repulsor rays, unibeam, smart missiles, lasers, EMP pulses, Hulkbuster armor, and nanotech-based weapons in later suits."
  },
  {
    name: 'Spider-Man',
    ...
    powers:
      "Wall-crawling, enhanced strength and agility, a powerful 'spider-sense' that alerts him to danger, super reflexes, and the ability to cling to surfaces. He also created web-shooters that allow him to swing across buildings and trap enemies.",
    weapons:
      "Mechanical web-shooters with various web types (standard, impact, taser-web), spider tracers for tracking, and occasionally suits designed by Stark Industries with advanced AI and gadgets."
  },
  {
    name: 'Thor',
    ...
    powers:
      "Godlike strength, durability, weather manipulation (thunder and lightning), flight with Mjolnir, dimensional travel.",
    weapons:
      "Mjolnir (enchanted hammer), Stormbreaker (battle axe), lightning blasts, enchanted Asgardian armor."
  },
  {
    ...
    powers:
      "Enhanced strength, speed, agility, reflexes, stamina, and healing. Master tactician and hand-to-hand combat expert.",
    weapons:
      "Vibranium shield, which absorbs energy and returns when thrown; also uses stealth gear and combat gear."
  },
  {
    name: 'Hulk',
    ...
    powers:
      "Unlimited strength based on anger, superhuman durability, regeneration, resistance to injury, immense leaping ability.",
    weapons:
      "Primarily his own fists and brute force; occasionally uses makeshift weapons like cars or debris."
  },
  {
    name: 'Black Widow',
    ...
    powers:
      "Peak human agility and strength, expert in martial arts, espionage, stealth, and infiltration. Fluent in multiple languages.",
    weapons:
      "Electro-shock batons, Widow’s Bite gauntlets, pistols, grappling hooks, and spy gadgets."
  },
  {
    name: 'Black Panther',
    ...
    powers:
      "Enhanced strength, speed, reflexes, and senses from the heart-shaped herb. Advanced martial arts and tracking skills.",
    weapons:
      "Vibranium suit, claws, energy daggers, kinetic absorption technology, and Wakandan tech."
  },
  {
    name: 'Hawkeye',
    ...
    powers:
      "Peak human accuracy, agility, and reflexes. Master of archery, acrobatics, and close-quarters combat.",
    weapons:
      "Trick arrows (explosive, EMP, grappling, smoke), custom bow, and combat knife."
  }
];
